...
void main() => runApp(Clothings());

class Clothings extends StatelessWidget {
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Which Clothing Items do you want to Rent',
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            Container(
                              height: 50.0,
                              decoration: BoxDecoration(image: DecorationImage(image: AssetImage('assets/clothslogoimg/blazzer_logo.jpg'))),
                            ),
                            Text(
                              'Blazzer',
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            Container(
                              height: 50.0,
                              decoration: BoxDecoration(image: DecorationImage(image: AssetImage('assets/clothslogoimg/shoes_logo.jpg'))),
                            ),
                            Text(
                              'Shoes',
                              style: TextStyle(fontFamily: 'Quicksand'),
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            Container(
                              height: 50.0,
                              decoration: BoxDecoration(image: DecorationImage(image: AssetImage('assets/clothslogoimg/curtain_logo.jpg'))),
                            ),
                            Text(
                              'Curtains',
                              style: TextStyle(fontFamily: 'Quicksand'),
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            Container(
                              height: 50.0,
                              decoration: BoxDecoration(image: DecorationImage(image: AssetImage('assets/clothslogoimg/custume_logo.jpg'))),
                            ),
                            Text(
                              'Costume',
                              style: TextStyle(fontFamily: 'Quicksand'),
