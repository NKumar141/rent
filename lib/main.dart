...
void main() async {
  ...
  await Firebase.initializeApp(
    options: FirebaseOptions(
      apiKey: "AIzaSyAxwfrWHgc31ehpCdMnY4FoUwlU1K-3Gzw",
      appId: "1:901263512334:android:4585c4e19576304b9ebd5f",
      messagingSenderId: "901263512334",
      projectId: "rentall-3ed0e",
    ),
  );
  runApp(MyApp());
}
          ...
          Column(
            children: <Widget>[
                        ...
                        child: InkWell(
                          ...
                          child: Column(
                            children: <Widget>[
                              Container(
                                height: 50.0,
                                decoration: BoxDecoration(image: DecorationImage(image: AssetImage('assets/vehicalslogoimg/cycle_logo.png'))),
                              ),
                              Text(
                                'Cycle',
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            Container(
                              height: 50.0,
                              decoration: BoxDecoration(image: DecorationImage(image: AssetImage('assets/vehicalslogoimg/bike_logo.png'))),
                            ),
                            Text(
                              'Bike',
                              style: TextStyle(fontFamily: 'Quicksand'),
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            Container(
                              height: 50.0,
                              decoration: BoxDecoration(image: DecorationImage(image: AssetImage('assets/vehicalslogoimg/car_logo.jpg'))),
                            ),
                            Text(
                              'Car',
                              style: TextStyle(fontFamily: 'Quicksand'),
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            Container(
                              height: 50.0,
                              decoration: BoxDecoration(image: DecorationImage(image: AssetImage('assets/vehicalslogoimg/van_logo.png'))),
                            ),
                            Text(
                              'Van',
                              style: TextStyle(fontFamily: 'Quicksand'),
              ...
              InkWell(
                ...
                child: itemCard('Sofa', 'assets/furnit.png', true),
              ),
              itemCard(
                'Pistachio',
                'assets/pistachio-nuts.png',
                true,
              ),
